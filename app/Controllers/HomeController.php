...
class HomeController extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['featuredPosts'] = getLatestPosts($this->activeLang->id, POST_NUM_LOAD_MORE + 2); //$this->latestCategoryPosts;
        ...
        $data['featuredEngPosts'] = getFeaturedEngPosts();

   
        //breaking news
        $data['breakingNews'] = getBreakingNews();
        //Category Based English News
        $data['englishNews'] = getEnglishNews();

        $data['limitLoadMorePosts'] = POST_NUM_LOAD_MORE;

        //echo"<pre>";
       // print_r($data['latestPosts'] );
        //echo"</pre>";
    ...
    public function search()
    {
        ...
        $data['sub_title'] = trans("search") . ', ' . $q;
        $data['posted_by_alt'] = trans("search") . ', ' . $q;
        $data['q'] = $q;
