...
class AuthModel extends BaseModel
{
    ...
    public function inputValues()
    {
        return [
            'name' => inputPost('name'),
            'designation' => inputPost('designation'),
    ...
    public function register()
    {
        ...
        $data['designation'] = $data['designation']?$data['designation']:'';
    ...
    public function editUser($id)
    {
        ...
        if (!empty($user)) {
            $data = [
                'username' => inputPost('username'),
                'name' => inputPost('name')?inputPost('name'):inputPost('username'),
                'designation' => inputPost('designation')?inputPost('designation'):'',
                'email' => inputPost('email'),
                'slug' => inputPost('slug'),
