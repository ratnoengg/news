...
class Globals extends BaseConfig
{
    ...
    public static $timestamp = 0;//timestamp as input
    public static $morning = 0;//when the date will change?
    public static $engHour = 0;//Current hour of English Date
    public static $engDate = 0;//Current date of English Date
    public static $engMonth = 0;//Current month of English Date
    public static $engYear = 0;//Current year of English Date
    public static $bangDate = 0;//generated Bangla Date
    public static $bangMonth = 0;//generated Bangla Month
    public static $bangYear = 0;//generated Bangla   Year
    public static $is_leapyear = 0;

    public static $bn_months = array("পৌষ", "মাঘ", "ফাল্গুন", "চৈত্র", "বৈশাখ", "জ্যৈষ্ঠ", "আষাঢ়", "শ্রাবণ", "ভাদ্র", "আশ্বিন", "কার্তিক", "অগ্রহায়ণ");
    public static $bn_month_dates = array(29,30,29,31,31,31,32,31,31,31,30,29);
    public static $bn_month_middate = array(16,14,14,13,14,14,15,15,15,15,14,14); 
    public static $lipyearindex = 3;
