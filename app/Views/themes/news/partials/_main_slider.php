    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-md-12 col-lg-3 top-headlines">
                <div class="row sidebar-widget ms-0 py-2 px-0 me-lg-0 me-3">
                    <div class="col-12 widget-head mb-2 px-0 ms-2">
                        <h3 class="top-headlines-title fs-5 pt-2"><?= trans("top_headlines"); ?></h3>
                    </div>
                    <div class="col-12">
                        <div class="items">
                            <?php $i = 1;
                                        ...
                                        <div class="item <?= $i == 1 ? ' item-first ' : '  '; ?>">
                                            ...
                                            <h3 class="title mb-0">
                                                <a href="<?= generatePostURL($item); ?>" <?php postURLNewTab($item); ?>>
                                                    <?= esc(characterLimiter($item->title, 270, '...')); ?>
                                                </a>
                                            </h3>
                            ...
                            if ($count < 20):?>
                                <div class="main-slider-item">
                                    ...
                                    <div class="caption">
                                        ...
                                        <?php if ($count < 2): ?>
                                            <h2 class="title"><?= esc(characterLimiter($item->title, 220, '...')); ?></h2>
                                        <?php else: ?>
                                            <h3 class="title"><?= esc(characterLimiter($item->title, 220, '...')); ?></h3>
                                        <?php endif; ?>
                                        <p class="post-meta">
                                            <?= loadView('post/_post_meta_feature', ['postItem' => $item]); ?>
                                        </p>
                                    </div>
                                </div>
                            <?php endif;
                                        ...
                                        <div class="caption">
                                            ...
                                            <h3 class="title mt-0">
                                                <a href="<?= generatePostURL($item); ?>" class="img-link"<?php postURLNewTab($item); ?>>
                                                    <?= esc(characterLimiter($item->title, 254, '...')); ?>
                                                </a>
                                            </h3>
                                            <p class="post-meta">
                                                <?= loadView("post/_post_meta_feature", ['postItem' => $item]); ?>
