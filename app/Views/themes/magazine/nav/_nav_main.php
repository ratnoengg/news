                                            ...
                                            <li class="nav-item text-center px-3">
                                                <span>
                                                    <div class="header-logo">
                                                        <div>
                                                            <a href="<?= langBaseUrl(); ?>" class="nav-link me-0 p-0">
                                                                <img class="logo" src="<?= $darkMode == 1 ? getLogoFooter() : getLogo(); ?>" alt="logo" >
                                                            </a>
                                                        </div>
                                                        <div class="dates d-flex justify-content-center gap-2" style="left: -175px;">
                                                            <p class="date fs-14 fw-medium mb-0 title"><?=convertToBanglaDate();?><?php set_time(time()); echo get_date();?></p>
                                                    ...
                                                    foreach ($categoryPosts as $item):
                                                        if ($i < $postLimit): ?>
                                                            <div class="col-sm-2 menu-post-item<?= $postLimit == 5 ? ' width20' : ' width25'; ?>">
                                                                ...
                                                                <?php endif; ?>
                                                                <h3 class="title"><a href="<?= generatePostURL($item); ?>" <?php postURLNewTab($item); ?>><?= esc(characterLimiter($item->title, 245, '...')); ?></a></h3>
