        ...
        <div class="row">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> <?= esc(characterLimiter($post->title, 260, '...')); ?></li>
                </ol>
            </nav>

            <?php  if (!empty($post) && $post->category_id==86 ): ?>
                <div class="col-md-12 col-lg-8">
                    <div class="post-content">
                        <div class="d-flex justify-content-center align-items-center mb-3">
                         ...
                         <p class="post-sub-title"><?= $post->sub_title; ?></p>
                         <?php endif; ?>
            ...
            <?php  elseif (!empty($post) && $post->category_id==87 ): ?>
                ...
                <div class="col-md-12 col-lg-8">
                    <div class="post-content">
                        ...
                        <div class="d-flex align-items-center post-details-meta mt-4 ">
                            <?php if ($generalSettings->show_post_author == 1): ?>

                                <?php if($post->posted_by_alt): ?>
                                     <?php if ($post->category_id == 39 || $post->category_id == 40|| $post->category_id == 41 ): ?>

                                         <div class="item-meta item-meta-author">
                                            <a href="<?= generateSearchURL($post->posted_by_alt); ?>">
                                            <span style="font-size: 16px; "> <b> <?= $post->posted_by_alt; ?></b></span></a>
                                         </div>
                                ...
                                <?php else: ?>   
                                    <div class="item-meta item-meta-author">
                                        <a href="<?= generateProfileURL($postUser->slug); ?>"><img src="<?= getUserAvatar($postUser->avatar); ?>" alt="<?= esc($postUser->username); ?>" width="32" height="32"><span style="font-size: 16px; "><?= esc($postUser->name?$postUser->name:$postUser->username); ?> 
                                       <?= $postUser->designation?'<small>, '.$postUser->designation.'</small>':''; ?>
                                        </span></a>
                                    </div>
                                <?php endif; ?>                                
                            <?php endif;
                            if ($generalSettings->show_post_date == 1): ?>
                                <div class="item-meta item-meta-date">
                                    ...
                                    <?php if ($post->category_id == 39 || $post->category_id == 40|| $post->category_id == 41 ): ?>
                                        ...
                                        <span><?= formatDateTimeFront($post->created_at); ?></span>
                                   <?php else : ?>  
                                    <span><?= getEngToBanDateTime($post->created_at); ?>&nbsp;&nbsp;<?php // formatHour($post->created_at); ?></span>
                                      <?php endif; ?>  
                                </div>
                                <?php if (!empty($post->updated_at)): ?>
                                    <div class="item-meta item-meta-date">
                                        ...
                                        <span><?= formatDateTimeFront($post->updated_at); ?></span>
                                   <?php else : ?>  
                                        <span><?= getEngToBanDateTime($post->updated_at); ?>&nbsp;&nbsp;<?php //formatHour($post->updated_at); ?></span>
                                         <?php endif; ?>  
                                    </div>
                                <?php endif;
                            endif; ?>
                        ...
                        <?php if($post->category_id==70): ?> 
                        <div class="d-flex flex-row post-opinions align-items-center mt-5">
                            <span>
                                
                               <?= trans("post_opinions_terms"); ?> 
                            </span>
                        </div>    
                        <?php endif; ?>
                                ...
                                <div class="col-sm-6 col-xs-12 left">
                                    <?php if (!empty($previousPost)): ?>
                                        ...
                                        <h3 class="title text-end">
                                            <a href="<?= generatePostURL($previousPost); ?>"><?= esc(characterLimiter($previousPost->title, 280, '...')); ?></a>
                                        </h3>
                                    <?php endif; ?>
                                </div>
                                <div class="col-sm-6 col-xs-12 right">
                                    <?php if (!empty($nextPost)): ?>
                                        ...
                                        <h3 class="title text-start">
                                            <a href="<?= generatePostURL($nextPost); ?>"><?= esc(characterLimiter($nextPost->title, 280, '...')); ?></a>
                                        </h3>
                                    <?php endif; ?>
                                </div>
                            </div>
                                                    ...
                                                    if ($i < 3):?>
                                                        <div class="col-sm-12 col-md-6 col-lg-4">
                                                            <div class="post-item<?= checkPostImg($item, 'class'); ?>">
                                                                ...
                                                                <?php endif; ?>
                                                                <h3 class="title fsize-16"><a href="<?= generatePostURL($item); ?>"<?php postURLNewTab($this, $item); ?>><?= esc(characterLimiter($item->title, 255, '...')); ?></a></h3>
                ...
                <div class="col-md-12 col-lg-8">
                    <div class="post-content">
                       ...
                       <!--  <div class="d-flex align-items-center post-details-meta mb-4">
                            <?php if ($generalSettings->show_post_author == 1): ?>
                                ...
                                <?php if($post->posted_by_alt): ?>
                                     <?php if ($post->category_id == 39 || $post->category_id == 40|| $post->category_id == 41 ): ?>
                                         ...
                                         <div class="item-meta item-meta-author">
                                            <span style="font-size: 16px; "> <b> <?= $post->posted_by_alt; ?></b></span>
                                         </div>
                        ...
                        echo loadView('partials/_ad_spaces', ['adSpace' => 'post_top', 'class' => '']);
                        ?>
                        <!-- <div class="d-flex post-share-buttons mb-2 mt-2">
                            <?= loadView('post/_post_share'); ?>
                        </div> -->
