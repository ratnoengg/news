<?= view('common/_json_ld'); ?>
    <footer id="footer">
        <div class="footer-inner" style="padding-top:30px !important; padding-bottom:30px !important;">
            <div class="container-xl">
                <div class="row justify-content-between">
                    <div class="col-sm-12 col-md-6 col-lg-4 footer-widget footer-widget-about">
                        <div class="footer-logo">
                        <a href="https://digibangla.news">    <img src="<?= getLogoFooter(); ?>" alt="digibangla logo" class="logo" width="240" height="auto" ></a>
                        </div>
                        ...
                        <p> 
                            <a href="https://info.flagcounter.com/TnVp"><img src="https://s11.flagcounter.com/count2/TnVp/bg_000000/txt_FFFFFF/border_CCCCCC/columns_3/maxflags_20/viewers_0/labels_1/pageviews_1/flags_0/percent_0/" alt="Free counters!" border="0"></a>
