...
<?php endif; ?>
<link href="<?= base_url($assetsPath . '/css/style-2.3.css'); ?>" rel="stylesheet">
<?php if ($rtl): ?>
<link href="<?= base_url($assetsPath . '/css/rtl-2.3.min.css'); ?>" rel="stylesheet"/>
<?php endif;
if ($darkMode == true) : ?>
<link href="<?= base_url($assetsPath . '/css/dark-2.3.css'); ?>" rel="stylesheet"/>
<?php endif; ?>

<link href="<?= base_url($assetsPath . '/css/style.css'); ?>" rel="stylesheet">
...
<header id="header" class="mb-0" <?= isset($headerNoMargin) ? '' : ''; ?>>
