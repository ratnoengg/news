<?php if (!empty($subCategories)): ?>
    <ul class="nav nav-tabs nav-category-block" role="tablist">
       ...
       <?php  if($category->id ==39): ?>
        <li class="nav-item category-block-links"><a href="javascript:void(0)" class="nav-link active" data-bs-toggle="tab" data-bs-target="#tabCategoryAll<?= esc($category->id); ?>"><?= "e-dbtech"; ?></a></li>
       <?php  else: ?>  
