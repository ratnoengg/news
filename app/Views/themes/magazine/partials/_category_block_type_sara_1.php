...
<div class="section section-category bg-blue-sara py-2">
    <div class="container-xl">
        <div class="section-title">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="title"> <a href="<?= generateCategoryURL(esc($category)); ?>"><img class="me-2" src="assets/img/sarabangla.jpg" style="width: 80px;" />খবর</a></h3>
                                            ...
                                            <div class="caption">
                                                <h3 class="title">
                                                    <a href="<?= generatePostURL($item); ?>" class="img-link"<?php postURLNewTab($item); ?> style="display: block; color: #fff;">
                                                        <?= esc(characterLimiter($item->title, 250, '...')); ?>
                                                    </a>
                                                </h3>
