                                        ...
                                        if (!empty($categoryPosts)):
                                            foreach ($categoryPosts as $item):
                                                if ($i > $start && $i <= $end && !in_array( $item->id, $feature_post)):?>
                                                    ...
                                                    <div class="col-sm-6 col-xs-6 col-md-6<?= $categoryWidgets->hasWidgets ? ' col-lg-6' : ' col-lg-3'; ?>">
                                                        <?= loadView('post/_post_item_small_eng', ['postItem' => $item, 'showLabel' => false]); ?>
                                                    </div>
                                                <?php 
                                                else:
                                                    $i--;
                                    ...
                                    <div class="row">
                                        ...
                                        if (!empty($featuredEngPosts)):
                                            foreach ($featuredEngPosts as $item):
                                                ...
                                                ?>
                                                    <div class="col-sm-12 col-md-12<?= $categoryWidgets->hasWidgets ? ' col-lg-6' : ' col-lg-12'; ?>">
