                    ...
                    <div class="col-sm-12 col-md-9">
                        ...
                        <form action="<?= base_url('edit-profile-post'); ?>" method="post" enctype="multipart/form-data" class="needs-validation">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control form-input" value="<?= esc(user()->name); ?>" placeholder="<?= trans("name"); ?>" required>
                            </div>

                             <div class="mb-3">
                                <label class="form-label"><?= trans("designation"); ?></label>
                                <input type="text" name="designation" class="form-control form-input" value="<?= esc(user()->designation); ?>" placeholder="<?= trans("designation"); ?>" >
                            </div>
