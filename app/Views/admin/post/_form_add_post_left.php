<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control text-area tinyMCEsmall" name="sub_title" placeholder="<?= trans('sub_title'); ?> "><?= old('sub_title'); ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control text-area tinyMCEsmall" name="summary" placeholder="<?= trans('summary'); ?> & <?= trans("description"); ?> (<?= trans('meta_tag'); ?>)"><?= old('summary'); ?></textarea>
        </div>
