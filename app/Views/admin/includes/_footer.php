        ...
        tinymce.init({
            ...
            directionality: directionality,
             contextmenu: '',
              ...
              paste_as_text: false,  // set true if you want plain text only

              // Optional: clean up pasted content
            ...
            toolbar: 'fullscreen code preview | undo redo | fontfamily | fontsize | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | numlist bullist | forecolor backcolor removeformat | image media link',
