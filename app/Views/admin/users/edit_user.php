                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control form-input" name="name" placeholder="<?= trans('name'); ?>" value="<?= esc($user->name); ?>">
                    </div>

                    <div class="form-group">
                        <label><?= trans('designation'); ?></label>
                        <input type="text" class="form-control form-input" name="designation" placeholder="<?= trans('designation'); ?>" value="<?= esc($user->designation); ?>">
                    </div>
